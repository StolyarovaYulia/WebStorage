...
optionBuilder.UseSqlServer("Server=KOMPUTER\\SQLEXPRESS;Database=WebStorage;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=true");
...
{
    OclUdpStream stream = client.GetStream();
    ...
    switch (actionType)
    {
        case ActionType.LoadFiles:
        {
            ...
            {
                Name = System.Text.Encoding.UTF8.GetString(fbytes),
                Bytes = dataBuffer,
